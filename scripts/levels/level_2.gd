...
func _ready() -> void:
	RenderingServer.global_shader_parameter_set("drunk_level", 0.3)
	_tween()
...
func _tween() -> void:
	...
	tween.tween_property(rudolph, "position", Vector2(38, -55), 3)
	tween.tween_property(santa, "position", Vector2(0, -55), 3).set_delay(0.25)
